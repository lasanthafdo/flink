...
/**
 * The scope format for the {@link org.apache.flink.runtime.metrics.groups.EdgeMetricGroup}.
 */
public class EdgeScopeFormat extends ScopeFormat {

	public EdgeScopeFormat(String format, TaskScopeFormat parentFormat) {
	...
	public String[] formatScope(TaskMetricGroup parent, String edgeId, String edgeName) {
