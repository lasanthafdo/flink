 ...
 */
public final class AdaptiveSchedulerFactory {

	public static final String SCHEDULER_TYPE_ADAPTIVE = "adaptive";

	private AdaptiveSchedulerFactory() {}
